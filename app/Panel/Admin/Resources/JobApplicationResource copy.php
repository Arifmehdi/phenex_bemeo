...
class JobApplicationResource extends Resource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            // 'create' => Pages\CreateJobApplication::route('/create'), // Usually applications come from frontend
            // 'view' => Pages\ViewJobApplication::route('/{record}'),
            // 'edit' => Pages\EditJobApplication::route('/{record}/edit'), // Usually applications are not edited
        ];
    }
}

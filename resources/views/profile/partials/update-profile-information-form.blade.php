<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="mobile_number" name="mobile_number" type="tel" class="block w-full mt-1"
                :value="old('mobile_number', $user->mobile_number)" required autocomplete="username" />

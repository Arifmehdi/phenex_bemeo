<x-app-layout>
    ...
    <form enctype="multipart/form-data" method="POST"
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 gap-4 mt-4 sm:grid-cols-2">
                <div class="">
                    <label class="mb-1.5 block font-semibold required">Name of Company:</label>
                ...
                <div>
                    <label class="mb-1.5 block font-semibold required">Type Of Company :</label>
                ...
                <div>
                    <label class="mb-1.5 block font-semibold required">Managing Director/Proprietor Name:</label>
                ...
                <div>
                    <label class="mb-1.5 block font-semibold required">Address:</label>
                ...
                <div>
                    <label class="mb-1.5 block font-semibold required">Mobile Number:</label>
                ...
                <div>
                    <label class="mb-1.5 block font-semibold required">Email:</label>
                ...
                <div>
                    <label class="mb-1.5 block font-semibold required">Gender Identity:</label>
                ...
                <div>
                    <label class="mb-1.5 block font-semibold">Due Amount :</label>
                    <input name="due_amount" id="due_amount" disabled
                        @if ($hasMembership) value="{{ $membership->due_amount }}" @endif
                        class="w-full p-2 border border-gray-300 rounded disabled:bg-gray-100" type="number" />
                </div>
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 gap-4 mt-4 sm:grid-cols-2">
                <div>
                    <label class="mb-1.5 block font-semibold required">Machine Quantity:</label>
                    <input name="machine_count" id="number_of_machines"
                        ...
                        @if ($hasMembership) value="{{ $membership->machine_count }}" disabled @endif />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input name="total_head" class="w-full p-2 border border-gray-300 rounded"
                        placeholder="Total Head" type="text"
                ...
                <div>
                    ...
                    <input name="needle_colors" class="w-full p-2 border border-gray-300 rounded"
                        placeholder="Needle/Colors:" type="text"
            ...
            <div class="grid grid-cols-1 gap-4 mt-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input name="yearly_subscription" id="yearly_fee" disabled
                        ...
                        placeholder="Yearly Subscription to BEMEA (Tk)" type="number"
                        @if ($hasMembership) value="{{ $membership->yearly_subscription }}" @endif />
                </div>

                <div style="display: none;">
                    <label class="mb-1.5 block font-semibold">Receipt No:</label>
                    <input name="receipt_no" class="w-full p-2 border border-gray-300 rounded"
                        placeholder="Receipt No" type="number"
                        @if ($hasMembership) value="{{ $membership->receipt_no }}" disabled @endif />
                </div>
                <div>
                    <label class="mb-1.5 block font-semibold">Date:</label>
                    <input name="payment_date" class="w-full p-2 border border-gray-300 rounded"
                        placeholder="Total Head" type="date"
                        @if ($hasMembership) value="{{ $membership->payment_date->format('Y-m-d') }}" disabled @endif />
                </div>
                <div>
                    <label class="mb-1.5 block font-semibold required">For The Year:</label>
                    <input name="payment_year" class="w-full p-2 border border-gray-300 rounded" min="2"
                        placeholder="For The Year:" type="number" required
                        @if ($hasMembership) value="{{ $membership->payment_year }}" disabled @else value="2" @endif />
                </div>
            ...
            <div class="grid grid-cols-1 gap-4 mt-4 sm:grid-cols-2">
                <div>
                    ...
                    <input name="sister_concerns" class="w-full p-2 border border-gray-300 rounded"
                        placeholder="Enter Sister Concerned Units/Group/Companies" type="text"
                ...
                <div>
                    ...
                    <input name="remarks" class="w-full p-2 border border-gray-300 rounded"
                        placeholder="Enter Additional Details or Remarks" type="text"
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div class="w-full mt-4 mb-6">
                    <label class="block mb-2 font-semibold text-gray-900">
                        Nomination Certificate Image Upload <small>(Max file size:2MB)</small>
                    </label>
                    <div
                ...
                <!-- Trade License -->
                <div class="w-full mt-4 mb-6">
                    <label class="block mb-2 font-semibold text-gray-900 required">
                        Trade license Must , If Have - Vat, Tin <small>(Max file size:2MB)</small>
                    </label>
                    <div
                        class="flex flex-col items-center justify-center w-full h-64 bg-white border-2 border-gray-300 border-dashed rounded-lg cursor-pointer hover:border-gray-400 file-upload-container">
                        <div class="flex flex-col items-center justify-center pt-5 pb-6 preview-container">
                            @if ($hasMembership && $membership->trade_license)
                ...
                <div class="w-full mt-4 mb-6">
                    <label class="block mb-2 font-semibold text-gray-900 required">
                        Managing Director/Proprietor Photo Upload <small>(Max file size:2MB)</small>
                    </label>
                    <div
                        class="flex flex-col items-center justify-center w-full h-64 bg-white border-2 border-gray-300 border-dashed rounded-lg cursor-pointer hover:border-gray-400 file-upload-container">
                        <div class="flex flex-col items-center justify-center pt-5 pb-6 preview-container">
        ...
        <div class="flex justify-between mt-6">
            {{-- @if ($hasMembership)
                <button type="submit" onclick="return confirm('Are you sure you want to cancel your membership?')"
                    class="px-6 py-3 text-white bg-red-600 rounded hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
                    Cancel Membership
                </button>
            @endif --}}
    ...
    @if ($hasMembership && (!$membership->expense_id || $membership->expense->is_verified == false))
        <!-- Payment -->
        <form enctype="multipart/form-data" method="POST"
            action="{{ route('membership.payment', $membership->id) }}"
            class="max-w-6xl p-8 mx-auto bg-white shadow-lg">
            @csrf
            <div class="flex items-center justify-between pb-4 mb-6 border-b-4 border-gray-300">
                <div>
                    <h1 class="text-2xl font-bold text-green-600">Membership Payment</h1>
            ...
            <div class="w-full mt-4 mb-6">
                <label class="block mb-2 font-semibold text-gray-900">
                    ...
                    @if ($membership->existing_member)
                        Due Amount: {{ $membership->due_amount }}
                    @else
                        {{ $membership->membership_fee + $membership->yearly_subscription * $membership->payment_year }}
                    @endif
                    BDT <small>(Max file size:2MB)</small>
                </label>
                <div
                    class="flex flex-col items-center justify-center w-full h-64 bg-white border-2 border-gray-300 border-dashed rounded-lg cursor-pointer hover:border-gray-400 file-upload-container">
                    <div class="flex flex-col items-center justify-center pt-5 pb-6 preview-container">
                        @if ($membership->expense_id && $membership->expense->images)
                            <div class="grid grid-cols-3 gap-2">
                                @foreach ($membership->expense->images as $photo)
                                    <img src="{{ asset('storage/' . $photo) }}" class="h-20 preview-image"
